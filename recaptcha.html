<div class="recaptcha-div">
    <div class="g-recaptcha" data-sitekey="6Le6eDkbAAAAADTnU__BGW5EgZ5nh2Mc7c7Qp-XX">
        <div style="width: 304px; height: 78px;">
            <div><iframe title="reCAPTCHA" src="https://www.google.com/recaptcha/api2/anchor?ar=2&amp;k=6Le6eDkbAAAAADTnU__BGW5EgZ5nh2Mc7c7Qp-XX&amp;co=aHR0cHM6Ly9maW5hbmNlaXJvLmhvc3RnYXRvci5jb20uYnI6NDQz&amp;hl=pt-BR&amp;v=FFtxPnbuZxq6kkeHkQJR2MNQ&amp;size=normal&amp;cb=33v666v0ztcr" width="304" height="78" role="presentation" name="a-68dkk12v7gif" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea>
...
<div class="conteinerrecaptcha">
    <div class="metade-esquerda">
        <div class="mensagem-expirou">A verificação expirou. Marque a caixa de seleção novamente.</div>
        <span class="icone-checkbox">
            <div class="animacao">
                <div class="spinner">
                    <div class="spinner-overlay">
                        <div class="checkbox-marcada">
                            <div class="icone-confere">
                                <div class="icone-expirado"></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <span class="nao-sou-um-robo">Não sou um robô</span>
    </div>
    <div>
        <div>
            <img class="logorecaptcha" src="view/public/image/recaptcha.png" alt="Recaptcha Image">
        </div>
        <div class="linha-de-baixo">
            <a class="privacidade" href="https://www.google.com/intl/pt-BR/policies/privacy/" target="_blank">Privacidade</a>
            <span class="traco"> - </span>
            <a class="termos" href="https://www.google.com/intl/pt-BR/policies/terms/" target="_blank">Termos</a>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const checkboxIcon = document.querySelector('.icone-checkbox');
        const spinner = document.querySelector('.spinner');
        const spinnerOverlay = document.querySelector('.spinner-overlay');
        const confereIcon = document.querySelector('.icone-confere');
        const expiradoIcon = document.querySelector('.icone-expirado');
        const mensagemExpirou = document.querySelector('.mensagem-expirou');
        ...
        checkboxIcon.addEventListener('click', function() {
            if (!isChecked) {
                ...
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        checkboxIcon.classList.add('checkbox-confere');
                        checkboxIcon.style.opacity = '1';
                        confereIcon.style.opacity = '1';
                        isChecked = true;
                    }, 5000);
                }, 1000);
            } else {
                if (isExpired) {
                    checkboxIcon.classList.remove('icone-confere');
                    checkboxIcon.classList.add('icone-expirado');
                }
            }
        });
        ...
        setTimeout(function() {
            if (!isChecked) {
                ...
                setTimeout(function() {
                    isExpired = true;
                    checkboxIcon.classList.remove('checkbox-confere');
                    checkboxIcon.classList.add('icone-expirado');
                }, 5000);
            }
        }, 60000);
